...
interface ContactSettingScreenProps {
  navigation: any;
}

const ContactSettingScreen = ({navigation}: ContactSettingScreenProps) => {
    ...
    <View style={[_s.container, {paddingTop: top}]}>
      ...
      <ImageBackground
        ...
        <View style={_s.content}>
          <Text style={_s.txt}>{txt.allowAccessToContacts}</Text>
          <Text style={_s.txt} />
          <Text style={_s.txt}>{txt.goToSetting}</Text>
          <Text style={_s.txt}>{txt.findTapMatch}</Text>
          <Text style={_s.txt}>{txt.enableContacts}</Text>
        </View>
        <StartBtn />
      </ImageBackground>
    </View>
